//==================================================================================================================================//
//!< @file		slBlendStateManager.cpp
//!< @brief		sl::BlendStateManagerクラスの実装
//!< @author	T.Haga
...
bool BlendStateManager::CreateDefaultBlendState(ID3D11Device*	pDevice)
{
